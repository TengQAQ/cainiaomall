...
public class DBOpenHelp extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL("insert into 'cm_user' values ('001','123456','秦腾辉',0,null)");
        db.execSQL("insert into 'cm_user' values ('002','123456','刘立杰',1,null)");
        db.execSQL("insert into 'cm_user' values ('003','123456','李文平',2,null)");
